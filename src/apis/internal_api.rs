...
pub struct InternalApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> InternalApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> InternalApiClient<C> {
        InternalApiClient {
...
impl<C: hyper::client::Connect>InternalApi for InternalApiClient<C> {
    fn call_contract(&self, body: ::models::ContractCallInput) -> Box<Future<Item = ::models::CallResult, Error = Error>> {
