...
impl ChannelWithdrawTx {
  pub fn new(channel_id: ::models::EncodedHash, to_id: ::models::EncodedHash, amount: i64, fee: i64, nonce: i64, state_hash: ::models::EncodedHash, round: i64) -> ChannelWithdrawTx {
    ChannelWithdrawTx {
  ...
  pub fn with_channel_id(mut self, channel_id: ::models::EncodedHash) -> ChannelWithdrawTx {
    self.channel_id = channel_id;
    self
  }
  ...
  pub fn with_to_id(mut self, to_id: ::models::EncodedHash) -> ChannelWithdrawTx {
    self.to_id = to_id;
    self
  }
  ...
  pub fn with_amount(mut self, amount: i64) -> ChannelWithdrawTx {
    self.amount = amount;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> ChannelWithdrawTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> ChannelWithdrawTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> ChannelWithdrawTx {
    self.nonce = nonce;
    self
  }
  ...
  pub fn with_state_hash(mut self, state_hash: ::models::EncodedHash) -> ChannelWithdrawTx {
    self.state_hash = state_hash;
    self
  }
  ...
  pub fn with_round(mut self, round: i64) -> ChannelWithdrawTx {
    self.round = round;
    self
  }
