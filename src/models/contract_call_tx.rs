...
impl ContractCallTx {
  pub fn new(caller_id: ::models::EncodedHash, contract_id: ::models::EncodedHash, vm_version: i32, fee: i32, amount: i32, gas: i32, gas_price: i32, call_data: ::models::EncodedByteArray) -> ContractCallTx {
    ContractCallTx {
      caller_id: caller_id,
      nonce: None,
  ...
  pub fn with_caller_id(mut self, caller_id: ::models::EncodedHash) -> ContractCallTx {
    self.caller_id = caller_id;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i32) -> ContractCallTx {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_contract_id(mut self, contract_id: ::models::EncodedHash) -> ContractCallTx {
    self.contract_id = contract_id;
    self
  }
  ...
  pub fn with_vm_version(mut self, vm_version: i32) -> ContractCallTx {
    self.vm_version = vm_version;
    self
  }
  ...
  pub fn with_fee(mut self, fee: i32) -> ContractCallTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i32) -> ContractCallTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_amount(mut self, amount: i32) -> ContractCallTx {
    self.amount = amount;
    self
  }
  ...
  pub fn with_gas(mut self, gas: i32) -> ContractCallTx {
    self.gas = gas;
    self
  }
  ...
  pub fn with_gas_price(mut self, gas_price: i32) -> ContractCallTx {
    self.gas_price = gas_price;
    self
  }
  ...
  pub fn with_call_data(mut self, call_data: ::models::EncodedByteArray) -> ContractCallTx {
    self.call_data = call_data;
    self
  }
