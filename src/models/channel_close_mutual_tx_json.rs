...
pub struct ChannelCloseMutualTxJson {
...
impl ChannelCloseMutualTxJson {
  pub fn new(channel_id: ::models::EncodedHash, from_id: ::models::EncodedHash, initiator_amount_final: i64, responder_amount_final: i64, fee: i64, nonce: i64, version: i64, _type: String) -> ChannelCloseMutualTxJson {
  ...
  pub fn with_channel_id(mut self, channel_id: ::models::EncodedHash) -> ChannelCloseMutualTxJson {
    self.channel_id = channel_id;
    self
  }
  ...
  pub fn with_from_id(mut self, from_id: ::models::EncodedHash) -> ChannelCloseMutualTxJson {
    self.from_id = from_id;
    self
  }
  ...
  pub fn with_initiator_amount_final(mut self, initiator_amount_final: i64) -> ChannelCloseMutualTxJson {
    self.initiator_amount_final = initiator_amount_final;
    self
  }
  ...
  pub fn with_responder_amount_final(mut self, responder_amount_final: i64) -> ChannelCloseMutualTxJson {
    self.responder_amount_final = responder_amount_final;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> ChannelCloseMutualTxJson {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> ChannelCloseMutualTxJson {
    self.fee = fee;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> ChannelCloseMutualTxJson {
    self.nonce = nonce;
    self
  }
  ...
  pub fn with_version(mut self, version: i64) -> ChannelCloseMutualTxJson {
    self.version = version;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> ChannelCloseMutualTxJson {
    self._type = _type;
    self
  }
