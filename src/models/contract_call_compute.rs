...
pub struct ContractCallCompute {
...
impl ContractCallCompute {
  pub fn new(caller_id: ::models::EncodedHash, contract_id: ::models::EncodedHash, vm_version: i32, fee: i32, amount: i32, gas: i32, gas_price: i32) -> ContractCallCompute {
    ContractCallCompute {
      caller_id: caller_id,
      nonce: None,
  ...
  pub fn with_caller_id(mut self, caller_id: ::models::EncodedHash) -> ContractCallCompute {
    self.caller_id = caller_id;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i32) -> ContractCallCompute {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_contract_id(mut self, contract_id: ::models::EncodedHash) -> ContractCallCompute {
    self.contract_id = contract_id;
    self
  }
  ...
  pub fn with_vm_version(mut self, vm_version: i32) -> ContractCallCompute {
    self.vm_version = vm_version;
    self
  }
  ...
  pub fn with_fee(mut self, fee: i32) -> ContractCallCompute {
    self.fee = fee;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i32) -> ContractCallCompute {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_amount(mut self, amount: i32) -> ContractCallCompute {
    self.amount = amount;
    self
  }
  ...
  pub fn with_gas(mut self, gas: i32) -> ContractCallCompute {
    self.gas = gas;
    self
  }
  ...
  pub fn with_gas_price(mut self, gas_price: i32) -> ContractCallCompute {
    self.gas_price = gas_price;
    self
  }
  ...
  pub fn with_function(mut self, function: String) -> ContractCallCompute {
    self.function = Some(function);
    self
  }
  ...
  pub fn with_arguments(mut self, arguments: String) -> ContractCallCompute {
    self.arguments = Some(arguments);
    self
  }
  ...
  pub fn with_call(mut self, call: String) -> ContractCallCompute {
    self.call = Some(call);
    self
  }
