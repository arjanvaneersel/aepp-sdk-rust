...
impl ChannelDepositTx {
  pub fn new(channel_id: ::models::EncodedHash, from_id: ::models::EncodedHash, amount: i64, fee: i64, nonce: i64, state_hash: ::models::EncodedHash, round: i64) -> ChannelDepositTx {
    ChannelDepositTx {
  ...
  pub fn with_channel_id(mut self, channel_id: ::models::EncodedHash) -> ChannelDepositTx {
    self.channel_id = channel_id;
    self
  }
  ...
  pub fn with_from_id(mut self, from_id: ::models::EncodedHash) -> ChannelDepositTx {
    self.from_id = from_id;
    self
  }
  ...
  pub fn with_amount(mut self, amount: i64) -> ChannelDepositTx {
    self.amount = amount;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> ChannelDepositTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> ChannelDepositTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> ChannelDepositTx {
    self.nonce = nonce;
    self
  }
  ...
  pub fn with_state_hash(mut self, state_hash: ::models::EncodedHash) -> ChannelDepositTx {
    self.state_hash = state_hash;
    self
  }
  ...
  pub fn with_round(mut self, round: i64) -> ChannelDepositTx {
    self.round = round;
    self
  }
