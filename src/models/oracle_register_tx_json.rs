...
pub struct OracleRegisterTxJson {
...
impl OracleRegisterTxJson {
  pub fn new(query_format: String, response_format: String, query_fee: i64, oracle_ttl: ::models::Ttl, account_id: ::models::EncodedHash, fee: i64, version: i64, _type: String) -> OracleRegisterTxJson {
  ...
  pub fn with_query_format(mut self, query_format: String) -> OracleRegisterTxJson {
    self.query_format = query_format;
    self
  }
  ...
  pub fn with_response_format(mut self, response_format: String) -> OracleRegisterTxJson {
    self.response_format = response_format;
    self
  }
  ...
  pub fn with_query_fee(mut self, query_fee: i64) -> OracleRegisterTxJson {
    self.query_fee = query_fee;
    self
  }
  ...
  pub fn with_oracle_ttl(mut self, oracle_ttl: ::models::Ttl) -> OracleRegisterTxJson {
    self.oracle_ttl = oracle_ttl;
    self
  }
  ...
  pub fn with_account_id(mut self, account_id: ::models::EncodedHash) -> OracleRegisterTxJson {
    self.account_id = account_id;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> OracleRegisterTxJson {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> OracleRegisterTxJson {
    self.fee = fee;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> OracleRegisterTxJson {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_vm_version(mut self, vm_version: i64) -> OracleRegisterTxJson {
    self.vm_version = Some(vm_version);
    self
  }
  ...
  pub fn with_version(mut self, version: i64) -> OracleRegisterTxJson {
    self.version = version;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> OracleRegisterTxJson {
    self._type = _type;
    self
  }
