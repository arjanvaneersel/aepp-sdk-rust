...
impl ChannelCreateTx {
  pub fn new(initiator_id: ::models::EncodedHash, initiator_amount: i64, responder_id: ::models::EncodedHash, responder_amount: i64, push_amount: i64, channel_reserve: i64, lock_period: i64, fee: i64, state_hash: ::models::EncodedHash) -> ChannelCreateTx {
    ChannelCreateTx {
  ...
  pub fn with_initiator_id(mut self, initiator_id: ::models::EncodedHash) -> ChannelCreateTx {
    self.initiator_id = initiator_id;
    self
  }
  ...
  pub fn with_initiator_amount(mut self, initiator_amount: i64) -> ChannelCreateTx {
    self.initiator_amount = initiator_amount;
    self
  }
  ...
  pub fn with_responder_id(mut self, responder_id: ::models::EncodedHash) -> ChannelCreateTx {
    self.responder_id = responder_id;
    self
  }
  ...
  pub fn with_responder_amount(mut self, responder_amount: i64) -> ChannelCreateTx {
    self.responder_amount = responder_amount;
    self
  }
  ...
  pub fn with_push_amount(mut self, push_amount: i64) -> ChannelCreateTx {
    self.push_amount = push_amount;
    self
  }
  ...
  pub fn with_channel_reserve(mut self, channel_reserve: i64) -> ChannelCreateTx {
    self.channel_reserve = channel_reserve;
    self
  }
  ...
  pub fn with_lock_period(mut self, lock_period: i64) -> ChannelCreateTx {
    self.lock_period = lock_period;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> ChannelCreateTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> ChannelCreateTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> ChannelCreateTx {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_state_hash(mut self, state_hash: ::models::EncodedHash) -> ChannelCreateTx {
    self.state_hash = state_hash;
    self
  }
