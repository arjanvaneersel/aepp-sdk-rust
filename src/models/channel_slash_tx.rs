...
impl ChannelSlashTx {
  pub fn new(channel_id: ::models::EncodedHash, from_id: ::models::EncodedHash, payload: String, fee: i64, poi: String) -> ChannelSlashTx {
    ChannelSlashTx {
  ...
  pub fn with_channel_id(mut self, channel_id: ::models::EncodedHash) -> ChannelSlashTx {
    self.channel_id = channel_id;
    self
  }
  ...
  pub fn with_from_id(mut self, from_id: ::models::EncodedHash) -> ChannelSlashTx {
    self.from_id = from_id;
    self
  }
  ...
  pub fn with_payload(mut self, payload: String) -> ChannelSlashTx {
    self.payload = payload;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> ChannelSlashTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> ChannelSlashTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> ChannelSlashTx {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_poi(mut self, poi: String) -> ChannelSlashTx {
    self.poi = poi;
    self
  }
