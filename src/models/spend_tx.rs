...
impl SpendTx {
  pub fn new(recipient_id: ::models::EncodedHash, amount: i64, fee: i64, sender_id: ::models::EncodedHash, payload: String) -> SpendTx {
    SpendTx {
  ...
  pub fn with_recipient_id(mut self, recipient_id: ::models::EncodedHash) -> SpendTx {
    self.recipient_id = recipient_id;
    self
  }
  ...
  pub fn with_amount(mut self, amount: i64) -> SpendTx {
    self.amount = amount;
    self
  }
  ...
  pub fn with_fee(mut self, fee: i64) -> SpendTx {
    self.fee = fee;
    self
  }
  ...
  pub fn with_ttl(mut self, ttl: i64) -> SpendTx {
    self.ttl = Some(ttl);
    self
  }
  ...
  pub fn with_sender_id(mut self, sender_id: ::models::EncodedHash) -> SpendTx {
    self.sender_id = sender_id;
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i64) -> SpendTx {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_payload(mut self, payload: String) -> SpendTx {
    self.payload = payload;
    self
  }
